// src/pages/ManagerFeedbackPage.tsx
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E8F1FF] via-white to-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl">Team Feedback</h1>
                <p className="text-xs text-slate-600">
                  See feedback for you and your team.
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        <Card className="p-6 rounded-3xl border-0 shadow-lg bg-white flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold">Give Feedback to Team</h2>
            <p className="text-sm text-slate-600">
              Recognize great work or share coaching feedback with your
              reports.
            </p>
          </div>
          <Button
